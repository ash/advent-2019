...
red: context [
    ...
    #import [libRedRT-file stdcall [
            ...
            f_sum: "f_sum" [] 
            f_average: "f_average" [] 
            f_ctx209~platform: "f_ctx209~platform" [octx [pointer! [integer!]]] 
            f_ctx238~interpreted?: "f_ctx238~interpreted?" [octx [pointer! [integer!]]] 
            f_ctx249~on-change*: "f_ctx249~on-change*" [octx [pointer! [integer!]]] 
            f_ctx247~on-change*: "f_ctx247~on-change*" [octx [pointer! [integer!]]] 
            f_ctx247~on-deep-change*: "f_ctx247~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx264~throw-error: "f_ctx264~throw-error" [octx [pointer! [integer!]]] 
            f_ctx264~make-time: "f_ctx264~make-time" [octx [pointer! [integer!]]] 
            f_ctx264~to-word: "f_ctx264~to-word" [octx [pointer! [integer!]]] 
            f_ctx264~pop: "f_ctx264~pop" [octx [pointer! [integer!]]] 
            f_ctx264~store: "f_ctx264~store" [octx [pointer! [integer!]]] 
            f_ctx264~transcode: "f_ctx264~transcode" [octx [pointer! [integer!]]] 
            f_ctx284~on-change*: "f_ctx284~on-change*" [octx [pointer! [integer!]]] 
            f_ctx287~on-change*: "f_ctx287~on-change*" [octx [pointer! [integer!]]] 
            f_ctx287~on-deep-change*: "f_ctx287~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx290~eval: "f_ctx290~eval" [octx [pointer! [integer!]]] 
            f_ctx290~eval-reaction: "f_ctx290~eval-reaction" [octx [pointer! [integer!]]] 
            f_ctx290~pending?: "f_ctx290~pending?" [octx [pointer! [integer!]]] 
            f_ctx290~check: "f_ctx290~check" [octx [pointer! [integer!]]] 
            ...
            f_ctx290~is~: "f_ctx290~is~" [octx [pointer! [integer!]]] 
            f_react?: "f_react?" [octx [pointer! [integer!]]] 
            f_react: "f_react" [octx [pointer! [integer!]]] 
            f_ctx302~do-quit: "f_ctx302~do-quit" [octx [pointer! [integer!]]] 
            f_ctx302~throw-error: "f_ctx302~throw-error" [octx [pointer! [integer!]]] 
            f_ctx302~syntax-error: "f_ctx302~syntax-error" [octx [pointer! [integer!]]] 
            f_ctx302~do-safe: "f_ctx302~do-safe" [octx [pointer! [integer!]]] 
            f_ctx302~do-code: "f_ctx302~do-code" [octx [pointer! [integer!]]] 
            f_ctx302~count-args: "f_ctx302~count-args" [octx [pointer! [integer!]]] 
            f_ctx302~func-arity?: "f_ctx302~func-arity?" [octx [pointer! [integer!]]] 
            f_ctx302~fetch-next: "f_ctx302~fetch-next" [octx [pointer! [integer!]]] 
            f_ctx302~eval: "f_ctx302~eval" [octx [pointer! [integer!]]] 
            f_ctx302~do-macro: "f_ctx302~do-macro" [octx [pointer! [integer!]]] 
            f_ctx302~register-macro: "f_ctx302~register-macro" [octx [pointer! [integer!]]] 
            f_ctx302~reset: "f_ctx302~reset" [octx [pointer! [integer!]]] 
            f_ctx302~expand: "f_ctx302~expand" [octx [pointer! [integer!]]] 
            ...
            f_ctx329~tail-idx?: "f_ctx329~tail-idx?" [octx [pointer! [integer!]]] 
            f_ctx329~push-color: "f_ctx329~push-color" [octx [pointer! [integer!]]] 
            f_ctx329~pop-color: "f_ctx329~pop-color" [octx [pointer! [integer!]]] 
            f_ctx329~close-colors: "f_ctx329~close-colors" [octx [pointer! [integer!]]] 
            f_ctx329~push: "f_ctx329~push" [octx [pointer! [integer!]]] 
            f_ctx329~pop: "f_ctx329~pop" [octx [pointer! [integer!]]] 
            f_ctx329~pop-all: "f_ctx329~pop-all" [octx [pointer! [integer!]]] 
            f_ctx329~optimize: "f_ctx329~optimize" [octx [pointer! [integer!]]] 
            f_rtd-layout: "f_rtd-layout" [octx [pointer! [integer!]]] 
            f_ctx327~line-height?: "f_ctx327~line-height?" [octx [pointer! [integer!]]] 
            f_ctx327~line-count?: "f_ctx327~line-count?" [octx [pointer! [integer!]]] 
            f_metrics?: "f_metrics?" [] 
            ...
            f_ctx349~on-change*: "f_ctx349~on-change*" [octx [pointer! [integer!]]] 
            f_ctx349~on-deep-change*: "f_ctx349~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx353~on-change*: "f_ctx353~on-change*" [octx [pointer! [integer!]]] 
            f_ctx353~on-deep-change*: "f_ctx353~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx357~on-change*: "f_ctx357~on-change*" [octx [pointer! [integer!]]] 
            f_ctx360~on-change*: "f_ctx360~on-change*" [octx [pointer! [integer!]]] 
            f_ctx363~capture-events: "f_ctx363~capture-events" [octx [pointer! [integer!]]] 
            f_ctx363~awake: "f_ctx363~awake" [octx [pointer! [integer!]]] 
            f_ctx371~init: "f_ctx371~init" [octx [pointer! [integer!]]] 
            f_draw: "f_draw" [] 
            f_ctx379~title-ize: "f_ctx379~title-ize" [octx [pointer! [integer!]]] 
            f_ctx379~sentence-ize: "f_ctx379~sentence-ize" [octx [pointer! [integer!]]] 
            f_ctx379~capitalize: "f_ctx379~capitalize" [octx [pointer! [integer!]]] 
            f_ctx379~adjust-buttons: "f_ctx379~adjust-buttons" [octx [pointer! [integer!]]] 
            f_ctx379~Cancel-OK: "f_ctx379~Cancel-OK" [octx [pointer! [integer!]]] 
            f_ctx377~process: "f_ctx377~process" [octx [pointer! [integer!]]] 
            f_ctx375~throw-error: "f_ctx375~throw-error" [octx [pointer! [integer!]]] 
            f_ctx375~process-reactors: "f_ctx375~process-reactors" [octx [pointer! [integer!]]] 
            f_ctx375~calc-size: "f_ctx375~calc-size" [octx [pointer! [integer!]]] 
            f_ctx375~align-faces: "f_ctx375~align-faces" [octx [pointer! [integer!]]] 
            f_ctx375~resize-child-panels: "f_ctx375~resize-child-panels" [octx [pointer! [integer!]]] 
            f_ctx375~clean-style: "f_ctx375~clean-style" [octx [pointer! [integer!]]] 
            f_ctx375~process-draw: "f_ctx375~process-draw" [octx [pointer! [integer!]]] 
            f_ctx375~pre-load: "f_ctx375~pre-load" [octx [pointer! [integer!]]] 
            f_ctx375~add-option: "f_ctx375~add-option" [octx [pointer! [integer!]]] 
            f_ctx375~add-flag: "f_ctx375~add-flag" [octx [pointer! [integer!]]] 
            f_ctx375~fetch-value: "f_ctx375~fetch-value" [octx [pointer! [integer!]]] 
            f_ctx375~fetch-argument: "f_ctx375~fetch-argument" [octx [pointer! [integer!]]] 
            f_ctx375~fetch-expr: "f_ctx375~fetch-expr" [octx [pointer! [integer!]]] 
            f_ctx375~fetch-options: "f_ctx375~fetch-options" [octx [pointer! [integer!]]] 
            f_ctx375~make-actor: "f_ctx375~make-actor" [octx [pointer! [integer!]]] 
            ...
            ctx264~make-hm: "ctx264~make-hm" [h [integer!] m [integer!]] 
            ctx264~make-msf: "ctx264~make-msf" [m [integer!] s [float!]] 
            ctx264~make-hms: "ctx264~make-hms" [h [integer!] m [integer!] s [integer!]] 
            ctx264~make-hmsf: "ctx264~make-hmsf" [h [integer!] m [integer!] s [float!]] 
            ctx264~make-binary: "ctx264~make-binary" [start [red-string!] end [red-string!] base [integer!]] 
            ctx264~make-tuple: "ctx264~make-tuple" [start [red-string!] end [red-string!]] 
            ctx264~make-number: "ctx264~make-number" [start [red-string!] end [red-string!] type [red-datatype!]] 
            ctx264~make-float: "ctx264~make-float" [start [red-string!] end [red-string!] type [red-datatype!]] 
            ctx264~make-hexa: "ctx264~make-hexa" [start [red-string!] end [red-string!] return: [integer!]] 
            ctx264~make-char: "ctx264~make-char" [start [red-string!] end [red-string!]] 
            ctx264~push-path: "ctx264~push-path" [stack [red-block!] type [red-datatype!]] 
            ctx264~set-path: "ctx264~set-path" [stack [red-block!]] 
            ctx264~make-word: "ctx264~make-word" [src [red-string!] type [red-datatype!]] 
            ctx264~new-line: "ctx264~new-line" [series [cell!]] 
            ...
            ctx281~encode: "ctx281~encode" [img [red-image!] where [cell!]] 
            ctx281~decode: "ctx281~decode" [data [cell!]] 
            event?: "event?" [value [cell!] return: [logic!]] 
            find-flag?: "find-flag?" [facet [cell!] flag [red-word!]] 
            ctx371~make-null-handle: "ctx371~make-null-handle" [] 
            ctx371~get-screen-size: "ctx371~get-screen-size" [id [integer!]] 
            ctx371~size-text: "ctx371~size-text" [face [red-object!] value [cell!]] 
            ctx371~on-change-facet: "ctx371~on-change-facet" [owner [red-object!] word [red-word!] value [cell!] action [red-word!] new [cell!] index [integer!] part [integer!]] 
            ctx371~update-font: "ctx371~update-font" [font [red-object!] flags [integer!]] 
            ctx371~update-para: "ctx371~update-para" [face [red-object!] flags [integer!]] 
            ctx371~destroy-view: "ctx371~destroy-view" [face [red-object!] empty? [logic!]] 
            ctx371~update-view: "ctx371~update-view" [face [red-object!]] 
            ctx371~refresh-window: "ctx371~refresh-window" [h [red-handle!]] 
            ctx371~redraw: "ctx371~redraw" [face [red-object!]] 
            ctx371~show-window: "ctx371~show-window" [id [red-handle!]] 
            ctx371~make-view: "ctx371~make-view" [face [red-object!] parent [red-handle!]] 
            ctx371~draw-image: "ctx371~draw-image" [image [red-image!] cmds [red-block!]] 
            ctx371~draw-face: "ctx371~draw-face" [face [red-object!] cmds [red-block!]] 
            ctx371~do-event-loop: "ctx371~do-event-loop" [no-wait? [logic!]] 
            ctx371~exit-event-loop: "ctx371~exit-event-loop" [] 
            ctx371~request-font: "ctx371~request-font" [font [red-object!] selected [red-object!] mono? [logic!]] 
            ctx371~request-file: "ctx371~request-file" [title [red-string!] name [red-file!] filter [red-block!] save? [logic!] multi? [logic!]] 
            ctx371~request-dir: "ctx371~request-dir" [title [red-string!] dir [red-file!] filter [red-block!] keep? [logic!] multi? [logic!]] 
            ctx371~text-box-metrics: "ctx371~text-box-metrics" [box [red-object!] arg0 [cell!] type [integer!]] 
            ctx371~update-scroller: "ctx371~update-scroller" [scroller [red-object!] flags [integer!]] 
    ...
    actions: context [
        #import [libRedRT-file stdcall [
                ...
                rename*: "red/actions/rename*" [] 
                update*: "red/actions/update*" [] 
